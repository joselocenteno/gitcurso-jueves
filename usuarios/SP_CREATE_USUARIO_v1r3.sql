...
BEGIN
	...
	DECLARE EXIT HANDLER FOR 1062
		...
		SET vSentencia = CONCAT("ERROR 1062: INSERT INTO usuarios_tb(usuario, nombre, email, telefono, imagen, rolid, rolid, iniciales)  VALUES ('",data_usuario,"','",data_nombre,"','",data_email,"','",data_telefono,"','",data_imagen,"',",data_rolid,", ",data_rolid,", '",data_iniciales,"')");
	...
	ELSE
		...
		IF vItems > 1 THEN
			...
			IF FN_CHECKTOKEN(data_token, data_usuarioid) = 1 THEN
				-- Construcción de la sentencia para la bitácora.
				SET vSentencia = CONCAT("INSERT INTO usuarios_tb(usuario, nombre, email, telefono, imagen, rolid, rolid, iniciales)  VALUES ('",data_usuario,"','",data_nombre,"','",data_email,"','",data_telefono,"','",data_imagen,"',",data_rolid,", ",data_rolid,", '",data_iniciales,"')");
				INSERT INTO usuarios_tb(usuario, nombre, email, telefono, imagen, rolid, color, color_texto, iniciales)
				VALUES (data_usuario, data_nombre, data_email, data_telefono, data_imagen, data_rolid, data_color, data_color_texto, data_iniciales);
				-- Guardar en la bitácora.
				INSERT INTO logs_tb (usuarioid, direccionip, plataforma, programa, sentencia, token) VALUES (data_usuarioid, data_direccionip, 1, "SP_CREATE_USUARIO", vSentencia, data_token);
				SELECT "ok";
				SET rowCount = 1;
